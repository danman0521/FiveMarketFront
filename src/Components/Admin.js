        ...
        <div className=' md:flex md:min-h-screen  '>
            ...
            <main className=' flex-1 '>
                ...
                <table className="  flex items-bot justify-center  ">
                    ...
                    <tbody className="bg-white text-center  border-collapse border-4 rounded-lg  border-red-500  ">
                        {
                            categoria.map(
                                item =>
                                    <tr className='uppercase' key={item._id}>
                                        ...
                                        <td className='p-3'>
                                            ...
                                            {item.nombre}
                                            <th style={{ width: '60%' }}></th>
                                            <img className=' border-4 rounded-lg  border-red-500  object-contain  h-35 w-48' src={item.imagen}></img>
